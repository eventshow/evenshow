    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=models.SET(events.models.get_default_category), related_name='category_events', to='events.Category')),
                ('created_by', models.ForeignKey(default='', on_delete=models.SET(events.models.get_sentinel_user), related_name='host_events', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.CharField(max_length=250, verbose_name='Customer_id')),
                ('is_paid_for', models.BooleanField(verbose_name='Is paid for?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ratings', to='events.Event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.URLField(blank=True, default='https://i.imgur.com/zcvvJuz.png', null=True, verbose_name='Picture url')),
                ...
                ('stripe_access_token', models.CharField(blank=True, editable=False, max_length=250, null=True, verbose_name='stripe_access_token')),
                ('stripe_user_id', models.CharField(blank=True, editable=False, max_length=250, null=True, verbose_name='stripe_user_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendee_enrollments', to=settings.AUTH_USER_MODEL)),
