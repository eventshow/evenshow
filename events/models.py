...
class Profile(models.Model):
    ...
    stripe_access_token = models.CharField('stripe_access_token', max_length=250, blank=True, null=True)
    stripe_user_id = models.CharField('stripe_user_id', max_length=250, blank=True, null=True)
